...
public enum ReefScoringOption {
  ...
  L2(
      ...
      (autos) ->
          autos.m_arm.goToPosition(
              ...
              new ArmPosition(
                  Arm.Positions.L3_OPP.mainPivotAngle(),
                  ElevatorConstants.MIN_PADDED_LENGTH,
                  Arm.Positions.L2_OPP.wristAngle())),
      (autos) ->
          new ScheduleCommand(
              autos.m_arm.goToPosition(
                  Arm.Positions.L2_OPP)) // so tapping the align button goes to L1
      ),
  L3(
      POI::selectedBatterySidePOI,
      (autos) -> autos.m_arm.goToPosition(Arm.Positions.L3_OPP),
      4,
      Arm.Positions.L3_OPP,
      0,
      (autos) ->
          autos.m_arm.goToPosition(
              new ArmPosition(
                  Arm.Positions.L3_OPP.mainPivotAngle(),
                  ElevatorConstants.MIN_PADDED_LENGTH,
                  Arm.Positions.L3_OPP.wristAngle())),
      (autos) ->
          autos.m_arm.goToPosition(
              new ArmPosition(
                  Arm.Positions.L3_OPP.mainPivotAngle(),
  ...
  L3_HIGH_ALG(
      POI::selectedBatterySidePOI,
      (autos) -> autos.m_arm.goToPosition(Arm.Positions.L3_HIGH_ALG),
      HandConstants.OUT_CORAL_VOLTAGE,
      Arm.Positions.L3_HIGH_ALG,
      0,
      (autos) ->
          autos.m_arm.goToPosition(
              new ArmPosition(
                  Arm.Positions.L3_HIGH_ALG.mainPivotAngle(),
                  ElevatorConstants.MIN_PADDED_LENGTH,
                  Radians.of(0))),
      (autos) ->
          autos.m_arm.goToPosition(
  ...
  L3_PIV(
      ...
      (autos) -> autos.m_arm.goToPosition(Arm.Positions.L3),
      -4,
      Arm.Positions.L3,
      0,
      (autos) ->
      ...
      (autos) ->
          autos.m_arm.goToPosition(
              new ArmPosition(
                  Arm.Positions.L3.mainPivotAngle(),
                  ElevatorConstants.MIN_PADDED_LENGTH,
                  Arm.Positions.L3.wristAngle()))),
  L4_PIV(
      POI::selectedPivotSidePOI,
      (autos) -> autos.m_arm.goToPosition(Arm.Positions.L4),
      -4,
      Arm.Positions.L4,
      0,
      (autos) ->
                  ...
                  .until(
                      () ->
                          autos.m_arm.position.pivotRadians()
                              < Arm.Positions.L4.pivotRadians() - Units.degreesToRadians(4))
                  .withTimeout(1),
              autos.m_arm.goToPosition(
                  new ArmPosition(
                      Arm.Positions.L3_OPP.mainPivotAngle(),
      ...
      (autos) ->
          autos.m_arm.goToPosition(
              new ArmPosition(
                  Arm.Positions.L4.mainPivotAngle(),
                  ElevatorConstants.MIN_PADDED_LENGTH,
