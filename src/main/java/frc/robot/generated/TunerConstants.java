...
import static frc.robot.subsystems.DrivetrainSysId.VoltsPerRotationPerSecond;
import static frc.robot.subsystems.DrivetrainSysId.VoltsPerRotationPerSecondSquared;
...
public class TunerConstants {
  ...
  private static final SysIdConstants sysid =
      RobotBase.isSimulation()
          ? DrivetrainSysId.SimSysIdConstants
          : DrivetrainSysId.AlphaSysIdConstants;
  ...
  public static final Current kSlipCurrent = Amps.of(180.0);
  ...
  // This needs to be tuned to your individual robot
  public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(4.245);
 ...
 // public static final Distance kWheelRadius = Inches.of(1.962); // grip lock wheels
    public static final Distance kWheelRadius = Inches.of(1.955); // Billet wheels
  ...
  private static final Angle kBackLeftEncoderOffset = Rotations.of(0.47314453125);
...
public static double kDriveRadius = Math.hypot(kFrontLeftXPos.in(Meter), kFrontLeftYPos.in(Meter));
  ...
  public static DriveBaseS createAlphaDrivetrain() {
    return new DriveBaseS(
        ...
        BackLeft.withEncoderOffset(kBackLeftEncoderOffset),
