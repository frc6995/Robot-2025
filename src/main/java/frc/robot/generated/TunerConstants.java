...
public class TunerConstants {
    ...
    private static final SysIdConstants sysid = RobotBase.isSimulation() ? DrivetrainSysId.SimSysIdConstants : DrivetrainSysId.AlphaSysIdConstants;
    ...
    private static final Slot0Configs driveGains = new Slot0Configs()
        ...
        .withKS(sysid.LINEAR_KS().in(Volts)).withKV(sysid.LINEAR_KV().in(VoltsPerRotationPerSecond));
