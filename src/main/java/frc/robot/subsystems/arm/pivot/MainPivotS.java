...
public class MainPivotS extends SubsystemBase {
  public class MainPivotConstants {
    ...
    public static TalonFXConfiguration configureLeader(TalonFXConfiguration config) {
      ...
      //TEMP
      config.MotionMagic.withMotionMagicCruiseVelocity(1.3).withMotionMagicAcceleration(1.64);//0.5, 0.66      //config.MotionMagic.withMotionMagicCruiseVelocity(1).withMotionMagicAcceleration(4);
