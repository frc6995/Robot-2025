...
public abstract class Arm {
  ...
  public record ArmPosition(Angle mainPivotAngle, Distance elevatorLength, Angle wristAngle) {
    ...
    public ArmPosition premove() {
      return new ArmPosition(
          mainPivotAngle,
          elevatorLength.gt(SAFE_PIVOT_ELEVATOR_LENGTH)
  ...
  public class Positions {
    ...
    public static final ArmPosition GROUND_CORAL =
        new ArmPosition(Degrees.of(5.1), ElevatorConstants.MIN_LENGTH, Degrees.of(-5.1));
    public static final ArmPosition GROUND_ALGAE =
        new ArmPosition(Degrees.of(21.5), Meters.of(0.75), Degrees.of(-70));
    public static final ArmPosition WALL_INTAKE_CORAL =
        new ArmPosition(Degrees.of(69.4), Meters.of(0.814), Degrees.of(-24));

    public static final ArmPosition POST_INTAKE_CORAL =
        new ArmPosition(
    ...
    public static final ArmPosition LOW_ALGAE =
        new ArmPosition(
            Degrees.of(55), ElevatorConstants.MIN_LENGTH.plus(Inches.of(8)), Degrees.of(-55));

    public static final ArmPosition HIGH_ALGAE_REEF =
        new ArmPosition(Degrees.of(90), Meters.of(1.025).plus(Inches.of(4)), Degrees.of(90 + 25));
    public static final ArmPosition HIGH_ALGAE =
        new ArmPosition(
            Degrees.of(60), ElevatorConstants.MIN_LENGTH.plus(Inches.of(22)), Degrees.of(-60));
    ...
    public static final ArmPosition SCORE_BARGE_PRE =
        new ArmPosition(Degrees.of(70), Meters.of(0.75), Degrees.of(0));
    public static final ArmPosition SCORE_PROCESSOR =
        new ArmPosition(Degrees.of(35), Meters.of(0.75), Degrees.of(-70));
  }
