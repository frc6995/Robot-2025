...
public class RealElevatorS extends Elevator {
  public class ElevatorConstants {
    ...
    private static TalonFXConfiguration configureLeader(TalonFXConfiguration config) {
      ...
      config.CurrentLimits.withSupplyCurrentLimitEnable(true).withSupplyCurrentLimit(Amps.of(80));
      config.Slot0.withKS(0)
          .withKV(K_V.in(VoltsPerRotationPerSecond))
          .withKA(K_A.in(VoltsPerRotationPerSecondSquared))
          .withKP(1)
          .withKD(0.25);
      config.MotionMagic.withMotionMagicAcceleration(150).withMotionMagicCruiseVelocity(72);
      return config;
    }
    ...
    private static TalonFXConfiguration configureFollower(TalonFXConfiguration config) {
      ...
      config.CurrentLimits.withSupplyCurrentLimitEnable(true).withSupplyCurrentLimit(Amps.of(60));
  ...
  public Command home() {
    return runOnce(() -> leader.setPosition(ElevatorConstants.MIN_LENGTH_ROTATIONS))
