...
public class Pathing {
  ...
  public static double aimingFFVelocity(
  ...
  public static Pose2d timeAdjustedPose(
      Pose2d currentPose, ChassisSpeeds robotRelativeSpeeds, double time) {
    return currentPose.transformBy(
        new Transform2d(
