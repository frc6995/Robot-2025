 ...
 * Based on https://gist.github.com/oh-yes-0-fps/c9f8483148505773eb72b7a75f90632b, slightly rearchitected by shueja.
 * 
...
public class PDData implements StructSerializable {
    ...
    protected static final class PowerDistributionCurrentsStruct implements Struct<PowerDistributionCurrents> {
        @Override
    ...
    /**
     * Create a new PDData object for the given CAN ID and module type.
     * This can be updated in place with the {@link #update()} method.
     */
